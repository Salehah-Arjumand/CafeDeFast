...
public class DynamicRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DynamicRvAdapter(Activity activity, List<DynamicRvModel> items, RecyclerView recyclerView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == VIEW_TYPE_ITEM){
            ...
            View view = LayoutInflater.from(activity).inflate(R.layout.dynamic_rv_progress, parent, false);
            return new LoadingViewHolder(view);
        }
        return null;
    }
